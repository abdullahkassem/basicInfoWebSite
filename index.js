...
const server = http.createServer((req, res) => {
    ...
    if (myPath == "/" || myPath == "" || myPath == "/index")
        fileToFetch = "index.html";
    else if (myPath == "/about") fileToFetch = "about.html";
    else if (myPath == "/contact-me") fileToFetch = "contact-me.html";
    else fileToFetch = myPath;
    ...
    fs.readFile(filePath, "utf8", (err, data) => {
        if (err) {
            ...
            else console.error("invalid path entered");
